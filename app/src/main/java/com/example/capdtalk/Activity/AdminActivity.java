...
public class AdminActivity extends AppCompatActivity
    ...
    /*
     *  MainActivity - 네비게이션바 항목 클릭시 Fragment 전환
     *  만든이 - 김세진
     * 최종 작성 일 - 2018 - 5 - 10
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.content_main,new AdminModeFragment()).commit();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AdminActivity.this,BoardWriteActivity.class);
                AdminActivity.this.startActivity(intent);
                overridePendingTransition(0,0);
            }
        });
...
//        ft.detach(this).attach(this).commit(); detach(this)문제발생 프래그먼트 refresh하는거
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.admin) {
            ...
            dialog = new CustomWeatherDialog(AdminActivity.this);
            dialog.show();
        }
