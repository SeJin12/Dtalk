...
import com.example.capdtalk.Request.NManagerRequest;
import com.example.capdtalk.Request.NoticeDeleteRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dlm_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NManagerRequest nManagerRequest = new NManagerRequest(dlm_title.getHint().toString(),dlm_content.getHint().toString(),
                        dlm_name.getText().toString(),dlm_date.getText().toString(),update_title,update_content,responseListener);

                RequestQueue queue = Volley.newRequestQueue(getContext());
                queue.add(nManagerRequest);
            }
        });
        ...
        dlm_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NoticeDeleteRequest noticeDeleteRequest = new NoticeDeleteRequest(dlm_title.getText().toString(),dlm_content.getText().toString(),
...
//        ft.detach(this).attach(this).commit(); detach(this)문제발생 프래그먼트 refresh하는거
    ...
    public NoticeManagerDialog(@NonNull Context tmp_context, String title, String content, String name, String date) {
        super(tmp_context);
        context = tmp_context;
        bring_title = title;
